    ...
    class VerifiedPhone(private  val phone : String) : AsyncTask<Void, Void, JSONObject>() {
        override fun doInBackground(vararg params: Void?): JSONObject {
            try {
                ...
                val url = URL("https://multipayment.co/api/register.php")
    ...
    class RegisterUser(
        ...
        override fun doInBackground(vararg params: Void?): JSONObject {
            try {
                ...
                val urlParameters = "a=RegisterFinal&filektp=${ktp}&filefotonktp=${selfAndKTP}&email=${email}&nohp=${phone}&name=${name}&password=${password}&status=0&typeuser=1"
